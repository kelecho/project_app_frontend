...
const Tarea = ({tarea,proyectoId}) => {
  ...
  const { handleModalEditarTarea, eliminarTarea } = useProyectos()
      ...
      <div>
        <div className="flex gap-4">
          ...
          {(() => {
            switch (prioridad) {
              case 'Baja':
                return <div className="flex gap-2 border-teal-600 border-2 rounded-full py-1 px-4 align-center h-8">
              ...
              case 'Media':
                return <div className="flex gap-2 border-orange-600 border-2 rounded-full py-1 px-4 align-center h-8">
              ...
              case 'Alta':
                return <div className="flex gap-2 border-red-600 border-2 rounded-full py-1 px-4 align-center h-8">
