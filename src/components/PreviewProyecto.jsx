    ...
    return (
        <li key={_id} className="flex justify-between gap-x-6 py-5">
            <div className="flex gap-x-4">
              <img className="h-12 w-12 flex-none rounded-full bg-gray-50" src={icono ? icono : ''} alt="" />
            ...
            <div className="hidden sm:flex sm:flex-col sm:items-end">
                ...
                <div className="mt-1 flex items-center gap-x-1.5">
                    <Link
                        to={`${_id}`} 
                        className="bg-blue-300 hover:bg-blue-400 text-grey-darkest font-bold py-2 px-4 rounded inline-flex items-center">
